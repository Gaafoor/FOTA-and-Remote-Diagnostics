...
#define NUMBER_OF_NVM_BLOCKS                (10U)
...
#define NVM_NVRAM_BLOCK_5_BASENUMBER        (BLOCK_10_NUMBER>>NVM_DATASET_SELECTION_BITS)
#define NVM_NVRAM_BLOCK_5_LENGTH            (BLOCK_6_SIZE-4)
